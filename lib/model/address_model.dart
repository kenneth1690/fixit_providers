...
class PrimaryAddress {
  ...
  PrimaryAddress.fromJson(Map<String, dynamic> json) {
    ...
    availabilityRadius = json['availability_radius'] != null ?double.parse(json['availability_radius'].toString()):null;
    status = json['status'];
    country =
    json['country'] != null ? CountryStateModel.fromJson(json['country']) : null;
