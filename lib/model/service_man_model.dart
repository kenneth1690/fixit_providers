...
class ServicemanModel {
  ...
  ServicemanModel(
      {this.id,
        ...
        this.reviewRatings,
        this.addresses,
        this.reviews,this.servicemanReviews,this.userDocuments});
  ...
  ServicemanModel.fromJson(Map<String, dynamic> json) {
    ...
    reviewRatings = json['review_ratings'] != null? json['review_ratings'].toString():null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (userDocuments != null) {
      data['user_documents'] =
          userDocuments!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
