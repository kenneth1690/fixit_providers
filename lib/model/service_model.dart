...
class Services {
  ...
  Services(
      ...
      this.selectedServiceNote,this.addresses,this.taxId});
  ...
  Services.fromJson(Map<String, dynamic> json) {
    ...
    reviewRatings = json['review_ratings'] != null? json['review_ratings'].cast<int>():null;
    ...
    if (json['zones'] != null) {
      zones = <ZoneModel>[];
      json['zones'].forEach((v) { zones!.add( ZoneModel.fromJson(v)); });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (selectedServiceMan != null) {
      ...
      data['addresses'] =
          addresses!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
