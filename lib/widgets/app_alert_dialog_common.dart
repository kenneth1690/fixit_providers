...
class AppAlertDialogCommon extends StatelessWidget {
  ...
  const   AppAlertDialogCommon(
      {super.key, this.isField = false, this.image, this.height, this.subtext, this.title, this.singleText, this.firstBText, this.secondBText, this.singleTap, this.firstBTap, this.secondBTap, this.controller, this.focusNode, this.validator, this.globalKey});
    ...
    return AlertDialog(
        ...
        content: Stack(alignment: Alignment.topRight, children: [
          Column(
            ...
            isField == true ? ButtonCommon(

                onTap: singleTap, title: singleText!) : BottomSheetButtonCommon(
                clearTap: firstBTap,
                applyTap: secondBTap,
                textTwo: secondBText,
                textOne: firstBText)
