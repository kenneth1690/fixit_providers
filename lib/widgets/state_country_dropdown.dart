...
class StateCountryDropdown extends StatelessWidget {
  ...
  const StateCountryDropdown({super.key, this.onChanged, this.items, this.selectedItem, this.icon, this.hint, this.validator});
       ...
       /* dropdownBuilder: (context, selectedItem) =>
        ...
        dropdownDecoratorProps: DropDownDecoratorProps(
            dropdownSearchDecoration: InputDecoration(contentPadding: const EdgeInsets.symmetric(vertical: 10),
               ...
               errorStyle: appCss.dmDenseRegular12.textColor(appColor(context).appTheme.red),
