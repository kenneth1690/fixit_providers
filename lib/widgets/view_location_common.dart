    ...
    return Container(
            ...
            child: Row(
                ...
                children: [
                  ...
                  ArrowRightCommon(
                      onTap: () =>
                          route.pushNamed(context, routeName.viewLocation,arg: {'latitude':address!.latitude,"longitude":address!.longitude}))
                ]).padding(
                horizontal: Insets.i15, top: Insets.i13, bottom: Insets.i11))
        .inkWell(onTap: () => route.pushNamed(context, routeName.viewLocation,arg: {'latitude':address!.latitude,"longitude":address!.longitude}));
  }
}
