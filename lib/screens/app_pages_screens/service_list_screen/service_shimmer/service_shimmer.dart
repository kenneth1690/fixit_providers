            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  const CommonWhiteShimmer(height: Sizes.s16, width: Sizes.s96).alignment(Alignment.centerLeft),
                  const VSpace(Sizes.s20),
                    ...
                    child: Row(
                      children:  List.generate(8, (index) {
                        return const Column(children: [
                          CommonWhiteShimmer(height: Sizes.s60, width: Sizes.s60, radius: 10),
                          VSpace(Sizes.s11),
                          CommonWhiteShimmer(height: Sizes.s13, width: Sizes.s60, radius: 10)
