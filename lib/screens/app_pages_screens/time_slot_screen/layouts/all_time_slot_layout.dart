        ...
        Row(
            ...
            children: [
              Text(data!.day.toString().substring(0,2).toUpperCase(),
               ...
               Row(
                  children: [
                    StartSlotLayout(title: data!.startTime,isSwitch: data!.status == "1" ?true:false).inkWell(onTap: onTap),
                    const HSpace(Sizes.s12),
                    StartSlotLayout(title: data!.endTime,isSwitch: data!.status == "1" ?true:false).inkWell(onTap: onTapSecond)
                  ]
              ),
