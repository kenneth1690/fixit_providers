      ...
      builder: (context1,value,child) {
        return PopScope(
          ...
          child: StatefulWrapper(
            onInit: ()=> Future.delayed(const Duration(milliseconds: 150), ()=> value.onReady(context)),
            child: RefreshIndicator(
              onRefresh: (){
                return value.onRefresh(context);
              },
              child: value.widget1Opacity == 0.0 ?const ServicemanShimmer() :  LoadingComponent(
                child: Scaffold(
                    appBar: AppBar(
                        leadingWidth: 80,
                    ...
                    body: value.servicemanModel == null ?Container(): SingleChildScrollView(
                        child: Column(children: [
                       Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                         const  ServicemenDetailProfileLayout(),
                         const  VSpace(Sizes.s20),
                        PersonalInfoLayout(servicemanModel: value.servicemanModel,)
                      ])
