          ...
          children: [
            Column(
                children: [
                  ...
                  ...service.services!.serviceAvailabilities!.asMap().entries.map((e) => ServicemanListLayout(
                      isDetail: true,
                      onDelete: ()=> service.onTapDetailLocationDelete(e.value.id,context,this,e.key),
