    ...
    return Consumer2<ThemeService,CommonApiProvider>(
      builder: (contextTheme,theme,api,child) {
        return Stack(alignment: Alignment.topRight, children: [
          userModel == null ? Container(): SizedBox(
                  width: MediaQuery.of(context).size.width,
                  child: Column(children: [

                      ProfilePicCommon(imageUrl: userModel!.media != null && userModel!.media!.isNotEmpty ?userModel!.media![0].originalUrl! : null,isProfile: true),
