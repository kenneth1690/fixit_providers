...
class ProfileSettingTopLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer2<ThemeService,ProfileProvider>(builder: (context, value,profile, child) {
      return Stack(alignment: Alignment.bottomCenter, children: [
        Column(children: [
          isServiceman
              ? userModel== null ? Container(): Column(children: [
                  ServicemanDetailProfileLayout(
                      imageUrl: userModel!.media != null &&
                              userModel!.media!.isNotEmpty
                          ? userModel!.media![0].originalUrl!
                          : null,
                      onEdit: () => route.pushNamed(context, routeName.profileDetails),),
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    Text(
                        userModel!.primaryAddress !=null? "${userModel!.primaryAddress!.country!.name} , ${userModel!.primaryAddress!.state!.name}":"",
                        style: appCss.dmDenseMedium12
          ...
          margin: const EdgeInsets.symmetric(horizontal: Insets.i17),
            ...
            child: Column(children: [
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                Text(
                    language(context,
                        isFreelancer ? appFonts.freelancer : isServiceman ?appFonts.serviceman : appFonts.company),
                    style: appCss.dmDenseMedium12
                        .textColor(appColor(context).appTheme.whiteColor))
              ]),
                ...
                Text(
                    language(
                        ...
                        isFreelancer
                            ...
                            :isServiceman ? appFonts.noOfCompletedService: appFonts.noOfServicemen),
                    style: appCss.dmDenseRegular12
                        .textColor(appColor(context).appTheme.whiteColor)),
                Text(
      userModel!= null?    isFreelancer
                        ? userModel!.served != null
                            ? userModel!.served!
                            : "0"
                        : servicemanList.length.toString():"0",
                    style: appCss.dmDenseMedium12
                        .textColor(appColor(context).appTheme.whiteColor))
              ])
