...
class StatusRow extends StatelessWidget {
  ...
  const StatusRow({super.key, this.title,this.style,this.title2,this.statusText, this.isDateLocation, this.statusId, this.onTap});
          ...
          Row(
              children: [
                ...
                if(isDateLocation == true)
                  SvgPicture.asset(eSvgAssets.edit,fit: BoxFit.scaleDown,colorFilter: ColorFilter.mode(appColor(context).appTheme.primary, BlendMode.srcIn)).inkWell(onTap: onTap).paddingSymmetric(horizontal: Insets.i6)
              ]
          ),
