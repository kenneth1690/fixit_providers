...
class BookingFilterLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final cat = Provider.of<CategoriesListProvider>(context);
          ...
          Expanded(
              child: Column(children: [
                        ...
                        child: Column(children: [
                          ...bookingStatusList
                              ...
                              BookingStatusFilterLayout(
                                  title: capitalizeFirstLetter(e.value.name),
                                  index: e.key,
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                        children: [
                          ...
                          SearchTextFieldCommon(focusNode: value.categoriesFocus,controller: value.categoryCtrl, onChanged: (v){
                            if(v.isEmpty){
                              cat.searchCategory(context,value.categoryCtrl.text);
                            }
                          },
                            onFieldSubmitted: (v) => cat.searchCategory(context,v),)
                          ...
                          cat.searchCtrl.text.isNotEmpty ?  Column(
                            children: [...cat.searchList
                                ...
                                ListTileLayout(
                                    data: e.value,
                                    isBooking: true,
                                    selectedCategory: value.selectedCategoryList,
                                    index: e.key,
                                    onTap: () =>
                                        value.onCategoryChange(context, e.value.id)).inkWell(onTap:  () =>
                                    value.onCategoryChange(context, e.value.id)))
                                ],
                          ) :
                          Column(
                ...
                BottomSheetButtonCommon(textOne: appFonts.clearAll,
                    ...
                    clearTap: ()=> value.clearTap(context)).paddingSymmetric(
